...
public final class PacketOpcodes {
    ...
    public static final int ChannelerSlabCheckEnterLoopDungeonReq = 1;
    public static final int ChannelerSlabCheckEnterLoopDungeonRsp = 1;
    public static final int ChannelerSlabEnterLoopDungeonReq = 1;
    public static final int ChannelerSlabEnterLoopDungeonRsp = 1;
    public static final int ChannelerSlabLoopDungeonChallengeInfoNotify = 1;
    public static final int ChannelerSlabLoopDungeonSelectConditionReq = 1;
    public static final int ChannelerSlabLoopDungeonSelectConditionRsp = 1;
    public static final int ChannelerSlabLoopDungeonTakeFirstPassRewardReq = 1;
    public static final int ChannelerSlabLoopDungeonTakeFirstPassRewardRsp = 1;
    public static final int ChannelerSlabLoopDungeonTakeScoreRewardReq = 1;
    public static final int ChannelerSlabLoopDungeonTakeScoreRewardRsp = 1;
    public static final int ChannelerSlabOneOffDungeonInfoNotify = 1;
    public static final int ChannelerSlabOneOffDungeonInfoReq = 1;
    public static final int ChannelerSlabOneOffDungeonInfoRsp = 1;
    public static final int ChannelerSlabSaveAssistInfoReq = 1;
    public static final int ChannelerSlabSaveAssistInfoRsp = 1;
    public static final int ChannelerSlabStageActiveChallengeIndexNotify = 1;
    public static final int ChannelerSlabStageOneofDungeonNotify = 1;
    public static final int ChannelerSlabTakeoffBuffReq = 1;
    public static final int ChannelerSlabTakeoffBuffRsp = 1;
    public static final int ChannelerSlabWearBuffReq = 1;
    public static final int ChannelerSlabWearBuffRsp = 1;
    ...
    public static final int DebugNotify = 1;
    ...
    public static final int FireworkNotify = 1;
    public static final int FireworkReq = 1;
    public static final int FireworkRsp = 1;
    public static final int FireworkSetNotify = 1;
    public static final int FireworkSetReq = 1;
    public static final int FireworkSetRsp = 1;
    ...
    public static final int GetQuestTalkHistoryReq = 1;
    public static final int GetQuestTalkHistoryRsp = 1;
    ...
    public static final int InBattleMechanicusEscapeMonsterNotify = 1;
    ...
    public static final int MusicGameGetBeatmapReq = 1;
    public static final int MusicGameGetBeatmapRsp = 1;
    ...
    public static final int MusicGameCreateBeatmapRsp = 1;
    public static final int MusicGameCreateBeatmapReq = 1;
    public static final int MusicGameSearchBeatmapRsp = 1;
    public static final int MusicGameSearchBeatmapReq = 1;
    public static final int MusicGameStartToPlayOthersBeatmapReq = 1;
    public static final int MusicGameStartToPlayOthersBeatmapRsp = 1;
    ...
    public static final int OneofGatherPointDetectorDataNotify = 1;
    ...
    public static final int PrivateChatSetSequenceReq = 1;
    public static final int PrivateChatSetSequenceRsp = 1;
    ...
    public static final int Unk2200_DEHCEKCILAB_ClientNotify = 1;
    public static final int Unk2700_AAHKMNNAFIH = 1;
    public static final int Unk2700_ACILPONNGGK_ClientReq = 1;
    public static final int Unk2700_ADBFKMECFNJ_ClientNotify = 1;
    public static final int Unk2700_AEEMJIMOPKD = 1;
    public static final int Unk2700_AHHFDDOGCNA = 1;
    public static final int Unk2700_AHOMMGBBIAH = 1;
    public static final int Unk2700_AIBHKIENDPF = 1;
    public static final int Unk2700_AIGKGLHBMCP_ServerRsp = 1;
    public static final int Unk2700_AIKOFHAKNPC = 1;
    public static final int Unk2700_AKIBKKOMBMC = 1;
    public static final int Unk2700_ALBPFHFJHHF_ClientReq = 1;
    public static final int Unk2700_ALFEKGABMAA = 1;
    public static final int Unk2700_AMOEOCPOMGJ_ClientReq = 1;
    public static final int Unk2700_ANEBALDAFJI = 1;
    public static final int Unk2700_ANGBJGAOMHF_ClientReq = 1;
    public static final int Unk2700_AOIJNFMIAIP = 1;
    public static final int Unk2700_APNHPEJCDMO = 1;
    public static final int Unk2700_APOBKAEHMEL = 1;
    public static final int Unk2700_BBLJNCKPKPN = 1;
    public static final int Unk2700_BBMKJGPMIOE = 1;
    public static final int Unk2700_BCFKCLHCBDI = 1;
    public static final int Unk2700_BCPHPHGOKGN = 1;
    public static final int Unk2700_BEDCCMDPNCH = 1;
    public static final int Unk2700_BEDLIGJANCJ_ClientReq = 1;
    public static final int Unk2700_BEINCMBJDAA_ClientReq = 1;
    public static final int Unk2700_BKEELPKCHGO_ClientReq = 1;
    public static final int Unk2700_BKGPMAHMHIG = 1;
    public static final int Unk2700_BLCHNMCGJCJ = 1;
    public static final int Unk2700_BLFFJBMLAPI = 1;
    public static final int Unk2700_BLHIGLFDHFA_ServerNotify = 1;
    public static final int Unk2700_BLNOMGJJLOI = 1;
    public static final int Unk2700_BMDBBHFJMPF = 1;
    public static final int Unk2700_BNABFJBODGE = 1;
    public static final int Unk2700_BNCBHLOKDCD = 1;
    public static final int Unk2700_BNMDCEKPDMC = 1;
    public static final int Unk2700_BOEHCEAAKKA = 1;
    public static final int Unk2700_BOPIJJPNHCK = 1;
    public static final int Unk2700_BPFNCHEFKJM = 1;
    public static final int Unk2700_BPPDLOJLAAO = 1;
    public static final int Unk2700_CALNMMBNKFD = 1;
    public static final int Unk2700_CAODHBDOGNE = 1;
    public static final int Unk2700_CBGOFDNILKA = 1;
    public static final int Unk2700_CCCKFHICDHD_ClientNotify = 1;
    public static final int Unk2700_CEEONDKDIHH_ClientReq = 1;
    public static final int Unk2700_CFLKEDHFPAB = 1;
    public static final int Unk2700_CGNFBKKBPJE = 1;
    public static final int Unk2700_CHICHNGLKPI = 1;
    public static final int Unk2700_CILGDLMHCNG_ServerNotify = 1;
    public static final int Unk2700_CIOMEDJDPBP_ClientReq = 1;
    public static final int Unk2700_CJKCCLEGPCM = 1;
    public static final int Unk2700_CLKGPNDKIDD = 1;
    public static final int Unk2700_CLMGFEOPNFH = 1;
    public static final int Unk2700_CNEIMEHAAAF = 1;
    public static final int Unk2700_CNNJKJFHGGD = 1;
    public static final int Unk2700_COGBIJAPDLE = 1;
    public static final int Unk2700_CPDDDMPAIDL = 1;
    public static final int Unk2700_CPEMGFIMICD = 1;
    public static final int Unk2700_DAGJNGODABM_ClientReq = 1;
    public static final int Unk2700_DBPDHLEGOLB = 1;
    public static final int Unk2700_DCBEFDDECOJ = 1;
    public static final int Unk2700_DCKKCAJCNKP_ServerRsp = 1;
    public static final int Unk2700_DDAHPHCEIIM = 1;
    public static final int Unk2700_DDLBKAMGGEE_ServerRsp = 1;
    public static final int Unk2700_DFOHGHKAIBO = 1;
    public static final int Unk2700_DGLIANMBMPA = 1;
    public static final int Unk2700_DJMKFGKGAEA = 1;
    public static final int Unk2700_DLAEFMAMIIJ = 1;
    public static final int Unk2700_EAAGDFHHNMJ_ServerReq = 1;
    public static final int Unk2700_EAAMIOAFNOD_ServerRsp = 1;
    public static final int Unk2700_EAGIANJBNGK_ClientReq = 1;
    public static final int Unk2700_EAOAMGDLJMP = 1;
    public static final int Unk2700_EBJCAMGPFDB = 1;
    public static final int Unk2700_EBOECOIFJMP = 1;
    public static final int Unk2700_ECBEAMKBGMD_ClientReq = 1;
    public static final int Unk2700_EDCIENBEEDI = 1;
    public static final int Unk2700_EDDNHJPJBBF = 1;
    public static final int Unk2700_EDMCLPMBEMH = 1;
    public static final int Unk2700_EELPPGCAKHL = 1;
    public static final int Unk2700_EHAMOPKCIGI_ServerNotify = 1;
    public static final int Unk2700_EHFBIEDHILL = 1;
    public static final int Unk2700_EJHALNBHHHD_ServerRsp = 1;
    public static final int Unk2700_EJIOFGEEIOM = 1;
    public static final int Unk2700_EKBMEKPHJGK = 1;
    public static final int Unk2700_EMHAHHAKOGA = 1;
    public static final int Unk2700_FADPOMMGLCH = 1;
    public static final int Unk2700_FCLBOLKPMGK = 1;
    public static final int Unk2700_FDJBLKOBFIH = 1;
    public static final int Unk2700_FEODEAEOOKE = 1;
    public static final int Unk2700_FFMAKIPBPHE = 1;
    public static final int Unk2700_FFOBMLOCPMH_ClientNotify = 1;
    public static final int Unk2700_FGEEFFLBAKO = 1;
    public static final int Unk2700_FGJBPNIKNDE = 1;
    public static final int Unk2700_FIODAJPNBIK = 1;
    public static final int Unk2700_FJEHHCPCBLG_ServerNotify = 1;
    public static final int Unk2700_FJJFKOEACCE = 1;
    public static final int Unk2700_FKCDCGCBIEA_ServerNotify = 1;
    public static final int Unk2700_FKMOKPBJIKO = 1;
    public static final int Unk2700_FLGMLEFJHBB_ClientReq = 1;
    public static final int Unk2700_FMNAGFKECPL_ClientReq = 1;
    public static final int Unk2700_FNHKFHGNLPP_ServerRsp = 1;
    public static final int Unk2700_FNJHJKELICK = 1;
    public static final int Unk2700_FOOOKMANFPE_ClientReq = 1;
    public static final int Unk2700_FPCJGEOBADP_ServerRsp = 1;
    public static final int Unk2700_FPJLFMEHHLB_ServerNotify = 1;
    public static final int Unk2700_FPOBGEBDAOD_ServerNotify = 1;
    public static final int Unk2700_GBJOLBGLELJ = 1;
    public static final int Unk2700_GDODKDJJPMP_ServerRsp = 1;
    public static final int Unk2700_GECHLGFKPOD_ServerNotify = 1;
    public static final int Unk2700_GEIGCHNDOAA = 1;
    public static final int Unk2700_GFMPOHAGMLO_ClientReq = 1;
    public static final int Unk2700_GIAILDLPEOO_ServerRsp = 1;
    public static final int Unk2700_GIFGEDBCPFC_ServerRsp = 1;
    public static final int Unk2700_GIFKPMNGNGB = 1;
    public static final int Unk2700_GKHEKGMFBJN = 1;
    public static final int Unk2700_GKKNFMNJFDP = 1;
    public static final int Unk2700_GLAPMLGHDDC_ClientReq = 1;
    public static final int Unk2700_GLIILNDIPLK_ServerNotify = 1;
    public static final int Unk2700_GLLIEOABOML = 1;
    public static final int Unk2700_GMNGEEBMABP = 1;
    public static final int Unk2700_GNDOKLHDHBJ_ClientReq = 1;
    public static final int Unk2700_GNOAKIGLPCG = 1;
    public static final int Unk2700_GNPPPIHBDLJ = 1;
    public static final int Unk2700_GPHLCIAMDFG = 1;
    public static final int Unk2700_GPIHGEEKBOO_ClientReq = 1;
    public static final int Unk2700_GPOIPAHPHJE = 1;
    public static final int Unk2700_HBLAGOMHKPL_ClientRsp = 1;
    public static final int Unk2700_HBOFACHAGIF_ServerNotify = 1;
    public static final int Unk2700_HDBFJJOBIAP_ClientReq = 1;
    public static final int Unk2700_HFCDIGNAAPJ = 1;
    public static final int Unk2700_HGMCBHFFDLJ = 1;
    public static final int Unk2700_HGMOIKODALP_ServerRsp = 1;
    public static final int Unk2700_HHGMCHANCBJ_ServerNotify = 1;
    public static final int Unk2700_HIIFAMCBJCD_ServerRsp = 1;
    public static final int Unk2700_HJKOHHGBMJP = 1;
    public static final int Unk2700_HKADKMFMBPG = 1;
    public static final int Unk2700_HMFCCGCKHCA = 1;
    public static final int Unk2700_HMHHLEHFBLB = 1;
    public static final int Unk2700_HMMFPDMLGEM = 1;
    public static final int Unk2700_HNFGBBECGMJ = 1;
    public static final int Unk2700_HOPDLJLBKIC_ServerRsp = 1;
    public static final int Unk2700_IAADLJBLOIN_ServerNotify = 1;
    public static final int Unk2700_IAAPADOAMIA = 1;
    public static final int Unk2700_IACKJNNMCAC_ClientReq = 1;
    public static final int Unk2700_IBOKDNKBMII = 1;
    public static final int Unk2700_ICABIPHHPKE = 1;
    public static final int Unk2700_IDADEMGCJBF_ClientNotify = 1;
    public static final int Unk2700_IDAGMLJOJMP = 1;
    public static final int Unk2700_IDGCNKONBBJ = 1;
    public static final int Unk2700_IEFAGBHIODK = 1;
    public static final int Unk2700_IEGOOOECBFH = 1;
    public static final int Unk2700_IGPIIHEDJLJ_ServerRsp = 1;
    public static final int Unk2700_IHLONDFBCOE_ClientReq = 1;
    public static final int Unk2700_IHOOCHJACEL = 1;
    public static final int Unk2700_IHPFBKANGMJ = 1;
    public static final int Unk2700_IJFEPCBOLDF = 1;
    public static final int Unk2700_IJLANPFECKC = 1;
    public static final int Unk2700_ILBBAKACCHA_ClientReq = 1;
    public static final int Unk2700_ILLDDDFLKHP = 1;
    public static final int Unk2700_IMHNKDHHGMA = 1;
    public static final int Unk2700_INBDPOIMAHK_ClientReq = 1;
    public static final int Unk2700_INOMEGGAGOP = 1;
    public static final int Unk2700_IPGJEAEFJMM_ServerRsp = 1;
    public static final int Unk2700_JCKGJAELBMB = 1;
    public static final int Unk2700_JCOECJGPNOL_ServerRsp = 1;
    public static final int Unk2700_JDMPECKFGIG_ServerNotify = 1;
    public static final int Unk2700_JEFIMHGLOJF = 1;
    public static final int Unk2700_JEHIAJHHIMP_ServerNotify = 1;
    public static final int Unk2700_JFGFIDBPGBK = 1;
    public static final int Unk2700_JHMIHJFFJBO = 1;
    public static final int Unk2700_JJAFAJIKDDK_ServerRsp = 1;
    public static final int Unk2700_JJCDNAHAPKD_ClientReq = 1;
    public static final int Unk2700_JKFGMBAMNDA_ServerNotify = 1;
    public static final int Unk2700_JKOKBPFCILA_ClientReq = 1;
    public static final int Unk2700_JLOFMANHGHI_ClientReq = 1;
    public static final int Unk2700_JNCINBLCNNL = 1;
    public static final int Unk2700_JOHOODKBINN_ClientReq = 1;
    public static final int Unk2700_JPLFIOOMCGG = 1;
    public static final int Unk2700_KAJNLGIDKAB_ServerRsp = 1;
    public static final int Unk2700_KDDPDHGPGEF_ServerRsp = 1;
    public static final int Unk2700_KDFNIGOBLEK = 1;
    public static final int Unk2700_KDNNKELPJFL = 1;
    public static final int Unk2700_KEMOFNEAOOO_ClientRsp = 1;
    public static final int Unk2700_KFPEIHHCCLA = 1;
    public static final int Unk2700_KGHOJPDNMKK_ServerRsp = 1;
    public static final int Unk2700_KGNJIBIMAHI = 1;
    public static final int Unk2700_KHLJJPGOELG_ClientReq = 1;
    public static final int Unk2700_KIHEEAGDGIL_ServerNotify = 1;
    public static final int Unk2700_KIIOGMKFNNP_ServerRsp = 1;
    public static final int Unk2700_KKEDIMOKCGD = 1;
    public static final int Unk2700_KMIDCPLAGMN = 1;
    public static final int Unk2700_KMNPMLCHELD_ServerRsp = 1;
    public static final int Unk2700_KNGFOEKOODA_ServerRsp = 1;
    public static final int Unk2700_KNMDFCBLIIG_ServerRsp = 1;
    public static final int Unk2700_KOGOPPONCHB_ClientReq = 1;
    public static final int Unk2700_KPGMEMHEEMD = 1;
    public static final int Unk2700_KPMMEBNMMCL = 1;
    public static final int Unk2700_LAFHGMOPCCM_ServerNotify = 1;
    public static final int Unk2700_LBJKLAGNDEJ_ClientReq = 1;
    public static final int Unk2700_LBOPCDPFJEC = 1;
    public static final int Unk2700_LCFGKHHIAEH_ServerNotify = 1;
    public static final int Unk2700_LDJLMCAHHEN = 1;
    public static final int Unk2700_LEMPLKGOOJC = 1;
    public static final int Unk2700_LGAGHFKFFDO_ServerRsp = 1;
    public static final int Unk2700_LGGAIDMLDIA_ServerReq = 1;
    public static final int Unk2700_LGHJBAEBJKE_ServerRsp = 1;
    public static final int Unk2700_LHMOFCJCIKM = 1;
    public static final int Unk2700_LIJCBOBECHJ = 1;
    public static final int Unk2700_LJINJNECBIA = 1;
    public static final int Unk2700_LKFKCNJFGIF_ServerRsp = 1;
    public static final int Unk2700_LKPBBMPFPPE_ClientReq = 1;
    public static final int Unk2700_LLBCBPADBNO = 1;
    public static final int Unk2700_LMAKABBJNLN = 1;
    public static final int Unk2700_LNBBLNNPNBE_ServerNotify = 1;
    public static final int Unk2700_LNMFIHNFKOO = 1;
    public static final int Unk2700_LOHBMOKOPLH_ServerNotify = 1;
    public static final int Unk2700_LPMIMLCNEDA = 1;
    public static final int Unk2700_MBIAJKLACBG = 1;
    public static final int Unk2700_MCJIOOELGHG_ServerNotify = 1;
    public static final int Unk2700_MCOFAKMDMEF_ServerRsp = 1;
    public static final int Unk2700_MDGKMNEBIBA = 1;
    public static final int Unk2700_MDPHLPEGFCG_ClientReq = 1;
    public static final int Unk2700_MEBFPBDNPGO_ServerNotify = 1;
    public static final int Unk2700_MEFJECGAFNH_ServerNotify = 1;
    public static final int Unk2700_MENCEGPEFAK = 1;
    public static final int Unk2700_MFAIPHGDPBL = 1;
    public static final int Unk2700_MFINCDMFGLD_ServerNotify = 1;
    public static final int Unk2700_MHMBDFKOOLJ_ClientNotify = 1;
    public static final int Unk2700_MIBHNLEMICB = 1;
    public static final int Unk2700_MIEJMGNBPJE = 1;
    public static final int Unk2700_MJAIKMBPKCD = 1;
    public static final int Unk2700_MJCCKKHJNMP_ServerRsp = 1;
    public static final int Unk2700_MKAFBOPFDEF_ServerNotify = 1;
    public static final int Unk2700_MKLLNAHEJJC_ServerRsp = 1;
    public static final int Unk2700_MKMDOIKBBEP = 1;
    public static final int Unk2700_MLMJFIGJJEH_ServerNotify = 1;
    public static final int Unk2700_MMDCAFMGACC_ServerNotify = 1;
    public static final int Unk2700_MMFIJILOCOP_ClientReq = 1;
    public static final int Unk2700_MNIBEMEMGMO = 1;
    public static final int Unk2700_MPPAHFFHIPI_ServerNotify = 1;
    public static final int Unk2700_NAEHEDLGLKA = 1;
    public static final int Unk2700_NBFJOJPCCEK_ServerRsp = 1;
    public static final int Unk2700_NBFOJLAHFCA_ServerNotify = 1;
    public static final int Unk2700_NCJLMACGOCD_ClientNotify = 1;
    public static final int Unk2700_NCMPMILICGJ = 1;
    public static final int Unk2700_NCPLKHGCOAH = 1;
    public static final int Unk2700_NDDBFNNHLFE = 1;
    public static final int Unk2700_NEHPMNPAAKC = 1;
    public static final int Unk2700_NELNFCMDMHE_ServerRsp = 1;
    public static final int Unk2700_NFGNGFLNOOJ_ServerNotify = 1;
    public static final int Unk2700_NGEKONFLEBB = 1;
    public static final int Unk2700_NGPMINKIOPK = 1;
    public static final int Unk2700_NIMPHALPEPO_ClientNotify = 1;
    public static final int Unk2700_NINHGODEMHH_ServerNotify = 1;
    public static final int Unk2700_NJNMEFINDCF = 1;
    public static final int Unk2700_NKIEIGPLMIO = 1;
    public static final int Unk2700_NLBJHDNKPCC = 1;
    public static final int Unk2700_NLJBCGILMIE = 1;
    public static final int Unk2700_NMEENGOJOKD = 1;
    public static final int Unk2700_NMJCGMOOIFP = 1;
    public static final int Unk2700_NMJIMIKKIME = 1;
    public static final int Unk2700_NNDKOICOGGH_ServerNotify = 1;
    public static final int Unk2700_NNMDBDNIMHN_ServerRsp = 1;
    public static final int Unk2700_OBCKNDBAPGE = 1;
    public static final int Unk2700_OBDHJJHLIKJ = 1;
    public static final int Unk2700_OCAJADDLPBB = 1;
    public static final int Unk2700_ODBNBICOCFK = 1;
    public static final int Unk2700_ODJKHILOILK = 1;
    public static final int Unk2700_OEDLCGKNGLH = 1;
    public static final int Unk2700_OFDBHGHAJBD_ServerNotify = 1;
    public static final int Unk2700_OGHMHELMBNN_ServerRsp = 1;
    public static final int Unk2700_OHDDPIFAPPD = 1;
    public static final int Unk2700_OHIKIOLLMHM = 1;
    public static final int Unk2700_OJHJBKHIPLA_ClientReq = 1;
    public static final int Unk2700_OJLJMJLKNGJ_ClientReq = 1;
    public static final int Unk2700_OKEKCGDGPDA = 1;
    public static final int Unk2700_OKNDIGOKMMC = 1;
    public static final int Unk2700_OLKJCGDHENH = 1;
    public static final int Unk2700_ONKMCKLJNAL = 1;
    public static final int Unk2700_PBGBOLJMIIB = 1;
    public static final int Unk2700_PCBGAIAJPHH = 1;
    public static final int Unk2700_PDGJFHAGMKD = 1;
    public static final int Unk2700_PFFKAEPBEHE_ServerRsp = 1;
    public static final int Unk2700_PFOLNOBIKFB = 1;
    public static final int Unk2700_PHFADCJDBOF = 1;
    public static final int Unk2700_PHLEDBIFIFL = 1;
    public static final int Unk2700_PIEJLIIGLGM_ServerRsp = 1;
    public static final int Unk2700_PIEJMALFKIF = 1;
    public static final int Unk2700_PJCMAELKFEP = 1;
    public static final int Unk2700_PJPMOLPHNEH = 1;
    public static final int Unk2700_PKCLMDHHPFI = 1;
    public static final int Unk2700_PKKJEOFNLCF = 1;
    public static final int Unk2700_PMKNJBJPLBH = 1;
    public static final int Unk2700_PPBALCAKIBD = 1;
    public static final int Unk2700_PPOGMFAKBMK_ServerRsp = 1;
    public static final int Unk2800_ACHELBEEBIP = 1;
    public static final int Unk2800_ANGFAFEJBAE = 1;
    public static final int Unk2800_BDAPFODFMNE = 1;
    public static final int Unk2800_BOFEHJBJELJ = 1;
    public static final int Unk2800_CHEDEMEDPPM = 1;
    public static final int Unk2800_COCHLKHLCPO = 1;
    public static final int Unk2800_DKDJCLLNGNL = 1;
    public static final int Unk2800_DNKCFLKHKJG = 1;
    public static final int Unk2800_DPINLADLBFA = 1;
    public static final int Unk2800_ECCLDPCADCJ = 1;
    public static final int Unk2800_EKGCCBDIKFI = 1;
    public static final int Unk2800_FHCJIICLONO = 1;
    public static final int Unk2800_GDDLBKEENNA = 1;
    public static final int Unk2800_HHPCNJGKIPP = 1;
    public static final int Unk2800_HKBAEOMCFOD = 1;
    public static final int Unk2800_IBDOMAIDPGK = 1;
    public static final int Unk2800_IECLGDFOMFJ = 1;
    public static final int Unk2800_IGKGDAGGCEC = 1;
    public static final int Unk2800_IILBEPIEBJO = 1;
    public static final int Unk2800_ILKIAECAAKG = 1;
    public static final int Unk2800_JCPNICABMAF = 1;
    public static final int Unk2800_KFNCDHFHJPD = 1;
    public static final int Unk2800_KHLHFFHGEHA = 1;
    public static final int Unk2800_KILFIICJLEE = 1;
    public static final int Unk2800_KJEOLFNEOPF = 1;
    public static final int Unk2800_KOMBBIEEGCP = 1;
    public static final int Unk2800_KPJKAJLNAED = 1;
    public static final int Unk2800_LGIKLPBOJOI = 1;
    public static final int Unk2800_LIBCDGDJMDF = 1;
    public static final int Unk2800_MNBDNGKGDGF = 1;
    public static final int Unk2800_NHEOHBNFHJD = 1;
    public static final int Unk2800_OFIHDGFMDGB = 1;
    public static final int Unk2800_OMGNOBICOCD = 1;
    public static final int Unk2800_OOKIPFHPJMG = 1;
    public static final int Unk3000_ACNMEFGKHKO = 1;
    public static final int Unk3000_AFMFIPPDAJE = 1;
    public static final int Unk3000_AGDEGMCKIAF = 1;
    public static final int Unk3000_BMLKKNEINNF = 1;
    public static final int Unk3000_CMKEPEDFOKE = 1;
    public static final int Unk3000_CNDHIGKNELM = 1;
    public static final int Unk3000_CPCMICDDBCH = 1;
    public static final int Unk3000_DCAHJINNNDM = 1;
    public static final int Unk3000_DCLAGIJJEHB = 1;
    public static final int RemoveCustomTeamReq = 1;
    public static final int Unk3000_DHEOMDCCMMC = 1;
    public static final int CustomTeamListNotify = 1;
    public static final int Unk3000_DJNBNBMIECP = 1;
    public static final int Unk3000_DLCDJPKNGBD = 1;
    public static final int Unk3000_DPEJONKFONL = 1;
    public static final int Unk3000_EBNMMLENEII = 1;
    public static final int Unk3000_EDGJEBLODLF = 1;
    public static final int Unk3000_EHJALCDEBKK = 1;
    public static final int Unk3000_EMGMOECAJDK = 1;
    public static final int Unk3000_EOLNDBMGCBP = 1;
    public static final int Unk3000_EPHGPACBEHL = 1;
    public static final int Unk3000_FAPNAHAEPBF = 1;
    public static final int Unk3000_FIPHHGCJIMO = 1;
    public static final int Unk3000_FPDBJJJLKEP = 1;
    public static final int Unk3000_GCBMILHPIKA = 1;
    public static final int Unk3000_GDMEIKLAMIB = 1;
    public static final int Unk3000_GMLAHHCDKOI = 1;
    public static final int Unk3000_GNLFOLGMEPN = 1;
    public static final int Unk3000_HBIPKOBMGGD = 1;
    public static final int Unk3000_HIJKNFBBCFC = 1;
    public static final int Unk3000_HPFGNOIGNAG = 1;
    public static final int Unk3000_IBMFJMGHCNC = 1;
    public static final int AddCustomTeamRsp = 1;
    public static final int Unk3000_IGCECHKNKOO = 1;
    public static final int AddCustomTeamReq = 1;
    public static final int Unk3000_IPAKLDNKDAO = 1;
    public static final int Unk3000_JDCOHPBDPED = 1;
    public static final int Unk3000_JIEPEGAHDNH = 1;
    public static final int Unk3000_JIMGCFDPFCK = 1;
    public static final int Unk3000_KEJGDDMMBLP = 1;
    public static final int Unk3000_KGDKKLOOIPG = 1;
    public static final int Unk3000_KHFMBKILMMD = 1;
    public static final int RemoveCustomTeamRsp = 1;
    public static final int Unk3000_KJNIKBPKAED = 1;
    public static final int Unk3000_KKHPGFINACH = 1;
    public static final int Unk3000_KOKEHAPLNHF = 1;
    public static final int Unk3000_LAIAGAPKPLB = 1;
    public static final int Unk3000_LHEMAMBKEKI = 1;
    public static final int Unk3000_LJIMEHHNHJA = 1;
    public static final int Unk3000_LLBCFCDMCID = 1;
    public static final int Unk3000_MEFJDDHIAOK = 1;
    public static final int Unk3000_MFCAIADEPGJ = 1;
    public static final int Unk3000_MFHOOFLHNPH = 1;
    public static final int Unk3000_MOIPPIJMIJC = 1;
    public static final int Unk3000_NBGBGODDBMP = 1;
    public static final int Unk3000_NHPPMHHJPMJ = 1;
    public static final int Unk3000_NJNPNJDFEOL = 1;
    public static final int Unk3000_NMEJCJFJPHM = 1;
    public static final int Unk3000_NMENEAHJGKE = 1;
    public static final int Unk3000_NNPCGEAHNHM = 1;
    public static final int Unk3000_NOMEJNJKGGL = 1;
    public static final int Unk3000_NPPMPMGBBLM = 1;
    public static final int Unk3000_ODGMCFAFADH = 1;
    public static final int Unk3000_PCGBDJJOIHH = 1;
    public static final int Unk3000_PDNJDOBPEKA = 1;
    public static final int Unk3000_PHCPMFMFOMO = 1;
    public static final int Unk3000_PILFPILPMFO = 1;
    public static final int Unk3000_PJLAPMPPIAG = 1;
    public static final int Unk3000_PNIEIHDLIDN = 1;
    public static final int Unk3000_PPDLLPNMJMK = 1;
